...
import { authlogout } from '../features/auth/authThunk'
         ...
         {user?(
             <div className='flex flex-col lg:flex-row gap-4 items-center'>
              <h1 className='text-white'>{user?.user?.username}</h1>
               <Button  onClick={handleLogout} name='Logout' className='w-full rounded-full bg-amber-500 px-4 py-2 text-slate-950 font-semibold hover:bg-amber-400 transition lg:w-auto' />
